...
export const AccessLog = mongoose.model('AccessLog', accessLogSchema, 'access_logs');
...
export const EnergyData = mongoose.model('EnergyData', energyDataSchema, 'energy_data');
